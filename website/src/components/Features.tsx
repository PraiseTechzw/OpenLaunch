          ...
          <Card className="relative overflow-hidden border-0 bg-gradient-to-r from-primary-500 via-accent-500 to-secondary-500 text-white shadow-2xl">
            ...
            <CardContent className="text-center relative">
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                ...
                <Button asChild variant="secondary" size="lg" className="border-2 border-white text-white hover:bg-white hover:text-primary-600 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200">
